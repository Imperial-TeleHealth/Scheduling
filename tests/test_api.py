...
async def test_view_patient_upcoming_appointments():
    ...
    mock_return_value = [
        {"patient_id": 1 , "provider_id": 1, "scheduled_time": "2022-01-01T09:00:00", "end_time": "2022-01-01T09:30:00", "status": "Scheduled", "reason_for_visit": "Annual checkup" , "video_link": "https://example.com/video/2022-01-01T09:00:00"},
        {"patient_id": 1 , "provider_id": 2, "scheduled_time": "2022-02-01T10:00:00", "end_time": "2022-02-01T10:30:00", "status": "Scheduled", "reason_for_visit": "Follow Up" , "video_link": "https://example.com/video/2022-01-01T10:00:00"}
    ]
...
#     mock_return_value = [
#         {"patient_id": 1 , "provider_id": 1, "scheduled_time": "2022-01-01T09:00:00", "end_time": "2022-01-01T09:30:00", "status": "Scheduled", "reason_for_visit": "Annual checkup" , "video_link": "https://example.com/video/2022-01-01T09:00:00"},
#         {"patient_id": 2 , "provider_id": 1, "scheduled_time": "2022-02-01T10:00:00", "end_time": "2022-02-01T10:30:00", "status": "Scheduled", "reason_for_visit": "Follow Up" , "video_link": "https://example.com/video/2022-01-01T10:00:00"}
#     ]

#     with patch('api.services.get_provider_upcoming_appointments', return_value=mock_return_value):
#         async with LifespanManager(app):
#             # async with AsyncClient(app=app, base_url="http://test") as client:
#             async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
#                 response = await client.get("/appointments/1/upcoming")
...
#     # Import the FastAPI app after setting up the test environment fixture
#     from api.main import app
#     mock_return_value = {"id": 1, "provider_id": 1, "start_time": "2022-01-01T09:00:00", "end_time": "2022-01-01T09:30:00", "status": "Booked"}

#     with patch('api.services.book_appointment', return_value=mock_return_value):
#         async with LifespanManager(app):
#             # async with AsyncClient(app=app, base_url="http://test") as client:
#             async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
#                 response = await client.post("/appointments/1/book")
#                 assert response.status_code == 200
#                 assert response.json() == mock_return_value
...
#             # async with AsyncClient(app=app, base_url="http://test") as client:
#             async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as client:
#                 response = await client.get("/appointments/1")
#                 assert response.status_code == 200
#                 assert response.json() == mock_return_value